...
route('admin.flashsale') }}">Flash Sale</a></div> 
        ...
        <a href="{{ route('admin.flashsale') }}" class="btn btn-icon icon-left 
btn-warning"> Kembali</a> 
 
        <div class="card mt-4"> 
            <form action="{{ route('flashsale.update', $flashSale->id) }}" 
                    ...
                    <div class="row"> 
                        <div class="col-6"> 
                            <div class="form-group"> 
                                ...
                                <input id="product_name" type="text" class="form
control" name="product_name" required="" 
...
class="form-control" name="original_price" required="" 
...
class="form-control" name="discount_price" required="" 
...
control" name="category" required="" 
...
id="description" cols="30" rows="10" 
                                    required="">{{ $flashSale->description 
}}</textarea> 
                                <div class="invalid-feedback"> 
...
for="customFile">Pilih Gambar</label> 
                    ...
                    <button type="submit" class="btn btn-icon icon-left btn
primary"> 
