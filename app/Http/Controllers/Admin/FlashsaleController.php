...
class FlashsaleController extends Controller
{
    ...
    {
        $flashSale = FlashSale::findOrFail($id); // Ambil data Flash Sale berdasarkan id
        return view('pages.admin.flashsale.edit', compact('flashSale')); // Pastikan nama variabelnya sesuai
    }
